...
\begin{tabular}{p{3in}p{16in}}
  \multicolumn{2}{l}{\bfseries\large Session 7A: Multimodal NLP / Lexical Semantics} \\\hline
    ...
    10:45--11:10
    &	[TACL] Back to Basics for Monolingual Alignment: Exploiting Word Similarity and Contextual Evidence \newline 
    ...
    12:00--12:25
    &	[TACL] From image descriptions to visual denotations: New similarity metrics for semantic inference over event descriptions \newline 
