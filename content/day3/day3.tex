...
%% Sessions %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{auto/papers/Wednesday.tex}
...
%% \begin{SessionOverview}{Parallel Session 7}{\daydateyear}
%%   {Multimodal NLP / Lexical Semantics}
%%   {Semantics III}
%%   {Machine Translation IV}
%%   {NLP Applications and NLP Enabled Technology II}
...
%% \begin{SessionOverview}{Parallel Session 8}{\daydateyear}
%%   {NLP for the Web and Social Media II}
%%   {Semantics / Information Extraction}
%%   {Machine Translation V}
%%   {Syntax, Parsing, and Tagging V}
%%   {Multilinguality and Multimodal NLP}
