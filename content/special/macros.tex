...
\newenvironment{tutorial}[3]{%
  ...
  % #1 tutorial bibtex ID
  % #2 date and time
  % #3 location

  % Cannot get \papertitle to expand
  \section[\textbf{T\theTutorialCounter:} \expandafter\papertitle\expandafter{#1}]{Tutorial \theTutorialCounter}
  \begin{center}
    \begin{Large}
      \bfseries \papertitle{#1}\\ \vspace{2em}\par
    \end{Large}
    {\itshape \tutorialauthors{#1}}\vspace{1em}\par
    #2 \vspace{1em}\\
    #3
  \end{center}}
