...
%      #1\linebreak #2\linebreak #4}\par\nopagebreak
  ...
  \end{minipage}\par\nopagebreak%
  \noindent{\small\input{auto/abstracts/#5}}\vspace{1em}\par}			% Space reduced to 2em from 3em - B
...
\newenvironment{tutorial}[4]{%
  ...
  % #2 tutorial name (e.g., ``Gaussian Processes for NLP'')
  % #3 authors (``Trevor Cohn, Daniel Preotiuc-Pietro, and Neil Lawrence'')
  % #4 date and time
  % #5 location
